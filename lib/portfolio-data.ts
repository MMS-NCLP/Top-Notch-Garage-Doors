...
export const projects: PortfolioProject[] = [
  ...
  {
    id: 'raised-panel-two-bay-crashed-door-replacement',
    ...
    location: 'Greensboro, NC',
    featured: false,
    caption: 'A two-bay garage with a crashed door that had buckled bottom panels and severely worn track hardware. The old door sat crooked in its frame, leaving gaps at the seal and creating a security concern. TNGD replaced both single doors with new white raised-panel sections, fresh tracks, and properly balanced hardware — doubling the curb appeal in a single job.',
    problem: 'The bottom panels of the existing garage door were buckled and crashed, leaving visible gaps at the weatherseal. The old radius track and cable drums showed heavy wear, and the door could no longer close flush against the frame.',
    solution: 'Complete removal of both old single doors and all worn hardware. New white raised-panel steel doors installed on both bays with fresh tracks, rollers, torsion springs, and proper weatherseal. Each door balanced and tested independently.',
    outcome: 'Two clean, matching raised-panel doors that close flush and seal tight. The two-bay garage went from an eyesore to a standout feature of the home\'s exterior.',
    images: [
      { src: '/images/portfolio/installations/raised-panel-two-bay-completed-exterior-nc.jpg', alt: 'Two-bay garage with both new white raised-panel doors completed exterior view NC', tag: 'after' },
      { src: '/images/portfolio/before-after/old-raised-panel-buckled-bottom-exterior-before-nc.jpg', alt: 'Old garage door with buckled crashed bottom panels exterior before replacement NC', tag: 'before' },
      { src: '/images/portfolio/before-after/buckled-panel-corner-gap-closeup-before-nc.jpg', alt: 'Close-up of buckled panel corner showing gap at bottom seal before replacement NC', tag: 'before' },
      { src: '/images/portfolio/before-after/old-track-curve-cable-drum-worn-before-nc.jpg', alt: 'Old worn radius track curve and cable drum showing hardware deterioration before NC', tag: 'before' },
