...
export const projects: PortfolioProject[] = [
...

  {
    ...
    images: [
      ...
      { src: '/images/portfolio/construction/tech-miter-saw-tngd-truck-new-construction-exterior-nc.jpg', alt: 'TNGD technician at miter saw station with service truck in driveway during new construction door install', tag: 'progress' },
      { src: '/images/portfolio/construction/chamberlain-opener-tngd-truck-new-construction-interior-nc.jpg', alt: 'Chamberlain myQ opener installed on ceiling with TNGD truck visible through open door at construction site', tag: 'progress' },
      { src: '/images/portfolio/construction/chamberlain-opener-two-bay-drywall-new-construction-nc.jpg', alt: 'Chamberlain opener mounted between two garage bays with door and window panels visible on fresh drywall', tag: 'progress' },
      { src: '/images/portfolio/construction/wall-mount-opener-adjacent-bay-window-new-construction-nc.jpg', alt: 'Wall-mount opener with track arm and adjacent bay visible through interior window at new construction site', tag: 'progress' },
      { src: '/images/portfolio/construction/new-construction-interior-opener-rail-tngd-truck-nc.jpg', alt: 'Interior view of new door with opener rail and TNGD truck visible at construction site', tag: 'progress' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/images/portfolio/before-after/old-door-removed-new-panels-staging-wide-exterior-nc.jpg', alt: 'Old garage door removed with new panels staged on sawhorses inside bay and old track on ground NC', tag: 'progress' },
      ...
      { src: '/images/portfolio/installations/tngd-tech-drill-door-jamb-brick-house-progress-nc.jpg', alt: 'TNGD technician with drill at door jamb during installation with brick house across street NC', tag: 'progress' },
      { src: '/images/portfolio/installations/new-panels-blue-film-track-install-interior-nc.jpg', alt: 'New door panels with blue protective film being installed on track system interior view NC', tag: 'progress' },
      { src: '/images/portfolio/installations/new-door-panels-mid-install-interior-blue-film-nc.jpg', alt: 'Interior view of first door panels installed with remaining blue-film panels staged on floor NC', tag: 'progress' },
      { src: '/images/portfolio/installations/technician-threading-lift-cable-bottom-bracket-closeup-nc.jpg', alt: 'Close-up of technician threading lift cable through bottom bracket hardware during door install NC', tag: 'progress' },
      ...
      { src: '/images/portfolio/screens/screen-door-frame-sawhorses-tngd-truck-high-point-nc.jpg', alt: 'Screen door frame on sawhorses with TNGD service truck in background High Point NC', tag: 'progress' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/images/portfolio/before-after/old-ryobi-opener-exposed-framing-track-before-nc.jpg', alt: 'Old Ryobi DIY opener mounted on exposed wood framing with worn track curve — what outdated hardware looks like NC', tag: 'before' },
      { src: '/images/portfolio/installations/two-bay-one-door-wide-exterior-progress-nc.jpg', alt: 'Wide exterior view of two-bay home with one new door installed and second bay still open during replacement NC', tag: 'progress' },
  ...
  },
  {
    ...
    serviceType: 'opener-work',
    systemType: 'Belt-Drive Smart Opener + Safety Sensors + Keypad',
    failureMode: 'Educational — Component Reference',
    materials: 'LiftMaster 1/3HP Motor + Chamberlain myQ Wall Control + Safety Photo-Eyes + Wireless Keypad',
    corridorPosition: 'central',
    anchorCity: 'Greensboro',
    secondaryCity: 'Greensboro',
    location: 'Greensboro, NC',
  ...
  },
  {
    ...
    serviceType: 'spring-work',
    systemType: 'Torsion Springs + Rollers + Cable Drums + End Bearings + Smart Opener',
    failureMode: 'Broken Torsion Spring — Cascading Hardware Failure',
    materials: 'Matched Torsion Springs + Cable Drums + Rollers + End Bearing Plates + LiftMaster Battery Backup myQ Belt-Drive',
    corridorPosition: 'central',
    anchorCity: 'Greensboro',
    secondaryCity: 'Greensboro',
    location: 'Greensboro, NC',
  ...
  {
    id: 'black-raised-panel-windows-board-batten-new-install',
    title: 'Black Raised-Panel Door with Windows — Board-and-Batten Premium Install',
    slug: 'black-raised-panel-windows-board-batten-new-install',
    serviceType: 'installations',
    systemType: 'Full Door + Chamberlain Opener',
    failureMode: 'New Install — Architectural Match',
    materials: 'Black Raised-Panel Insulated Steel with Window Inserts + Chamberlain Ceiling-Mount Opener',
    corridorPosition: 'east',
    anchorCity: 'Durham',
    secondaryCity: 'Durham',
    location: 'Durham, NC',
    featured: true,
    caption: 'When the architecture speaks this loudly, the garage door has to answer. This board-and-batten home with natural stone accents called for a door that complemented the modern farmhouse aesthetic without competing with it. The black raised-panel with window inserts does exactly that — adding depth and natural light while the dark finish anchors the white facade. Every detail matters: the window placement echoes the home\'s fenestration pattern, and the textured panel surface adds visual weight that balances the stone chimney. If your garage door is fighting your curb appeal instead of finishing it, this is what the right match looks like.',
    problem: 'A premium board-and-batten home with natural stone accents needed a garage door that elevated the modern farmhouse aesthetic. The wrong door choice on a home this distinctive would undermine the entire exterior design investment.',
    solution: 'Black raised-panel insulated door with window inserts installed on a single-bay opening. Clean white trim framing, paired with modern exterior sconces. Interior hardware includes a Chamberlain opener with proper ceiling mounting and full track alignment. The dark door finish creates intentional contrast against the white board-and-batten siding.',
    outcome: 'The black door became the focal point of the home\'s curb appeal — visually anchoring the facade while the window row pulls natural light into the garage. A door that doesn\'t just close an opening, it finishes the architecture.',
    images: [
      { src: '/images/portfolio/installations/black-raised-panel-windows-board-batten-exterior-nc.jpg', alt: 'Black raised-panel garage door with window inserts on white board-and-batten home with modern sconces NC', tag: 'after' },
      { src: '/images/portfolio/installations/black-door-stone-facade-wide-exterior-after-nc.jpg', alt: 'Wide view of black garage door on board-and-batten home with natural stone facade and mulch landscaping NC', tag: 'after' },
      { src: '/images/portfolio/installations/black-door-stone-chimney-golden-hour-exterior-nc.jpg', alt: 'Black raised-panel door at golden hour showing stone chimney and full home exterior Durham NC', tag: 'after' },
      { src: '/images/portfolio/installations/black-door-windows-interior-opener-mounted-after-nc.jpg', alt: 'Interior view of new black door with window inserts and ceiling-mounted opener installed NC', tag: 'after' },
      { src: '/images/portfolio/installations/black-raised-panel-windows-closeup-left-evening-nc.jpg', alt: 'Close-up of black raised-panel door with windows in evening light showing stone accent detail NC', tag: 'after' },
    ],
  },
  {
    id: 'black-raised-panel-townhouse-multi-unit-new-construction',
    title: 'Black Raised-Panel Doors with Windows — Multi-Unit Townhouse New Construction',
    slug: 'black-raised-panel-townhouse-multi-unit-new-construction',
    serviceType: 'installations',
    systemType: 'Multi-Unit Full Door + Opener + Smart Keypad',
    failureMode: 'New Build — Multi-Unit Development',
    materials: 'Black Raised-Panel Insulated Steel with Window Inserts + Chamberlain Opener + LiftMaster Video Keypad',
    corridorPosition: 'central',
    anchorCity: 'Greensboro',
    secondaryCity: 'Greensboro',
    location: 'Greensboro, NC',
    featured: true,
    caption: 'New construction doesn\'t wait — and neither does TNGD. This multi-unit townhouse development needed garage doors that matched the modern farmhouse aesthetic across every unit: black raised-panel doors with window inserts on white board-and-batten facades. Each unit received a Chamberlain opener system with LiftMaster video keypad for smart access and security camera monitoring. When builders need doors installed on schedule, on spec, and across multiple units, this is what that partnership looks like. From empty bays to finished curb appeal — every detail coordinated, every system tested, every unit move-in ready.',
    problem: 'A multi-unit townhouse development under construction needed garage door installations coordinated across multiple units simultaneously. Each bay required doors that matched the modern farmhouse architectural spec — black finish, window inserts, proper trim integration — with smart opener systems installed and tested before occupancy.',
    solution: 'Black raised-panel insulated doors with window inserts across all units (addresses 834-836). Each unit received a Chamberlain ceiling-mount opener, LiftMaster video keypad with built-in camera for keyless smart access, and full hardware alignment. Board-and-batten facade integration with dark trim framing and modern exterior sconces.',
    outcome: 'Every unit move-in ready with fully operational garage door systems. The consistent black-on-white aesthetic ties the development together while the smart access systems give each homeowner app-based control and security camera monitoring from day one.',
    images: [
      { src: '/images/portfolio/installations/black-raised-panel-windows-townhouse-836-exterior-nc.jpg', alt: 'Black raised-panel garage door with window inserts on white board-and-batten townhouse unit 836 NC', tag: 'after' },
      { src: '/images/portfolio/construction/townhouse-duplex-open-bays-construction-phase-nc.jpg', alt: 'Multi-unit townhouse duplex with open garage bays during construction phase before door installation NC', tag: 'progress' },
      { src: '/images/portfolio/construction/day-ave-empty-garage-bay-before-burlington-nc.jpg', alt: 'Empty garage bay interior with water heater and construction materials visible before door install NC', tag: 'progress' },
      { src: '/images/portfolio/construction/day-ave-flush-panel-black-accent-interior-nc.jpg', alt: 'Interior view of newly installed raised-panel door with transom windows and strut bracing NC', tag: 'progress' },
      { src: '/images/portfolio/construction/duplex-new-construction-interior-second-bay-install-burlington-nc.jpg', alt: 'Second bay interior with new door installed and wiring hanging for upcoming opener mount NC', tag: 'progress' },
      { src: '/images/portfolio/construction/day-ave-new-construction-interior-nc.jpg', alt: 'Interior view of installed door with workbench and tools staged for opener wiring NC', tag: 'progress' },
      { src: '/images/portfolio/construction/day-ave-opener-motor-install-burlington-nc.jpg', alt: 'Chamberlain opener motor mounted on ceiling with track arm and ladder during installation NC', tag: 'progress' },
      { src: '/images/portfolio/installations/chamberlain-opener-interior-new-door-install-progress-nc.jpg', alt: 'Chamberlain ceiling-mount opener with new door partially open during installation NC', tag: 'progress' },
      { src: '/images/portfolio/construction/duplex-new-construction-interior-opener-track-burlington-nc.jpg', alt: 'Completed opener and galvanized track system with door retracted to ceiling interior view NC', tag: 'after' },
      { src: '/images/portfolio/installations/black-doors-windows-townhouse-834-two-bay-after-nc.jpg', alt: 'Townhouse unit 834 with two black raised-panel doors and window inserts installed after completion NC', tag: 'after' },
      { src: '/images/portfolio/openers/liftmaster-video-keypad-camera-exterior-jamb-nc.jpg', alt: 'LiftMaster video keypad with built-in camera mounted on exterior door jamb for smart access NC', tag: 'after' },
      { src: '/images/portfolio/installations/townhouse-multi-unit-all-doors-tngd-truck-after-nc.jpg', alt: 'All townhouse units with black doors installed wide view with Top-Notch Garage Doors service truck NC', tag: 'after' },
    ],
  },
  {
    id: 'motorized-retractable-screen-carriage-door-complete-system',
    title: 'Motorized Retractable Screen — Carriage-House Door Complete System Install',
    slug: 'motorized-retractable-screen-carriage-door-complete-system',
    serviceType: 'screen-doors',
    systemType: 'Motorized Retractable Screen + Carriage Door + Wall-Mount Opener',
    failureMode: 'Lifestyle Upgrade — Ventilated Living Space',
    materials: 'Motorized Retractable Screen + Carriage-House Door with Stockton Windows + LiftMaster Wall-Mount Opener',
    corridorPosition: 'central',
    anchorCity: 'Greensboro',
    secondaryCity: 'Greensboro',
    location: 'Greensboro, NC',
    featured: true,
    caption: 'Your garage doesn\'t have to choose between fresh air and keeping bugs out. This motorized retractable screen transforms a standard garage opening into a ventilated outdoor living space — deploy it with a button press and roll it up when you\'re done. Paired with a carriage-house door featuring decorative hardware and stockton window inserts, this system gives the homeowner curb appeal when closed and a screened patio when open. The wall-mount LiftMaster opener keeps the ceiling clear, and the screen\'s side guide tracks ensure a tight seal all the way down. If you\'ve been using your garage as a workshop, gym, or hangout space, this is the upgrade that makes it comfortable year-round.',
    problem: 'The homeowner wanted to use their garage as a ventilated living and entertainment space without dealing with insects, debris, or loss of privacy. A standard open doorway offers no protection, and traditional screen door solutions don\'t integrate cleanly with sectional garage door systems.',
    solution: 'A motorized retractable screen system installed with precision side guide tracks, a header-mounted roller tube, and push-button deployment. The existing carriage-house door with decorative hardware and stockton window inserts was paired with a wall-mount LiftMaster opener to keep ceiling space clear for the screen roller mechanism.',
    outcome: 'The garage now functions as a screened outdoor room at the push of a button. The screen deploys smoothly along the guide tracks for a tight seal, and retracts fully into the header-mounted tube when not in use — completely invisible behind the carriage-house door.',
    images: [
      { src: '/images/portfolio/screens/motorized-retractable-screen-deployed-exterior-nc.jpg', alt: 'Motorized retractable garage screen fully deployed on double-bay opening exterior view NC', tag: 'after' },
      { src: '/images/portfolio/installations/carriage-house-door-decorative-hardware-stockton-windows-nc.jpg', alt: 'White carriage-house garage door with decorative hardware and stockton window inserts NC', tag: 'after' },
      { src: '/images/portfolio/screens/technician-installing-screen-guide-track-progress-nc.jpg', alt: 'TNGD technician installing motorized screen side guide track on garage door jamb NC', tag: 'progress' },
      { src: '/images/portfolio/screens/retractable-screen-roller-tube-header-closeup-nc.jpg', alt: 'Retractable screen roller tube mounted at garage header close-up detail NC', tag: 'after' },
      { src: '/images/portfolio/openers/liftmaster-wall-mount-opener-internals-wiring-nc.jpg', alt: 'LiftMaster wall-mount garage door opener with cover open showing internals and wiring NC', tag: 'after' },
      { src: '/images/portfolio/screens/motorized-screen-interior-view-deployed-driveway-nc.jpg', alt: 'Interior view through deployed motorized screen showing filtered driveway and TNGD truck NC', tag: 'after' },
    ],
  },
];
