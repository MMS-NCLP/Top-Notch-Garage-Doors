...
export const metadata = genMeta({
  ...
  description: 'Terms of Service for Top-Notch Garage Doors website and garage door services.',
  path: '/terms',
});
    ...
    <section className="py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-sm max-w-none text-foreground/70 space-y-6">
          ...
          <p>Top-Notch Garage Doors LLC provides garage door repair, installation, maintenance, garage screen doors, and related services serving the Piedmont Triad corridor from Statesville to Durham, NC. Service availability, pricing, and scheduling are subject to change without notice.</p>
