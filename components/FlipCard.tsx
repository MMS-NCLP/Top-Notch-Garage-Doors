      ...
      >
        ...
        >
          ...
          <div className="relative z-10 p-6 flex flex-col h-full">
            <h3 className="font-display text-base text-white uppercase mb-2 tracking-wide">{title}</h3>
            <p className="text-sm text-white/90 leading-relaxed flex-1">{backInsight}</p>
            {blogSlug && (
              <Link
                href={`/blog/${blogSlug}`}
